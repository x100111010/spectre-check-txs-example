...
# win: pipenv run python -m grpc_tools.protoc -I".\spectred\protos" --python_out=".\\spectred" --grpc_python_out=".\\spectred" ".\spectred\protos\rpc.proto" ".\spectred\protos\messages.proto" ".\spectred\protos\p2p.proto"
